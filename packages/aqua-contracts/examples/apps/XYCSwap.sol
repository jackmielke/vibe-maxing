...
contract XYCSwap is AquaApp {
        ...
        returns (uint256 amountOut)
    {
        ...
        IXYCSwapCallback(msg.sender).(tokenIn, tokenOut, amountIn, amountOut, strategy.maker, address(this), strategyHash, takerData);
        _safeCheckAquaPush(strategy.maker, sxycSwapCallbacktrategyHash, tokenIn, balanceIn + amountIn);
    }
